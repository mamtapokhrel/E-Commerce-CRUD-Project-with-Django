...
Built by: Mamata Pokharel | BSc.CSIT, St. Xavier's College, Kathmandu Course: E-Commerce |  6th Semester
Tech stack
Python 3.12 · Django 4.2 · MySQL 8.0 · Django ORM · Pillow (image uploads) · Bootstrap 5 · Git
Features
